...
class DecoderOnlyTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.dec_layers     = nn.ModuleList([SelfAttentionDecoderLayer(d_model=d_model, num_heads=num_heads, d_ff=d_ff, dropout=dropout) for i in range(num_layers)]) # ModuleList of decoder layers
...
class EncoderDecoderTransformer(nn.Module):
    ...
    def __init__(
        ...
        self.dec_layers = nn.ModuleList([CrossAttentionDecoderLayer(d_model, num_decoder_heads, d_ff_decoder, dropout) for i in range(num_encoder_layers)]) # ModuleList of decoder layers
